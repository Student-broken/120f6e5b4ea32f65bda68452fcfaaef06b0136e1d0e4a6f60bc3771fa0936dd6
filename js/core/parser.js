/**
 * Parses the raw text data pasted from the student portal.
 * @param {string} text - The raw text content.
 * @returns {object|null} A structured object with { nom, etapeKey, etapeData } or null if parsing fails.
 */
export function parsePortalData(text) {
    try {
        ...
        if (!nom || !etapeNumber) {
            console.error("Parsing failed: Could not find student name or semester number.");
            return null;
        }
